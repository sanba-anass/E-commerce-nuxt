<template>
	...
	<div class="blogs">
		<BlogItem
			...
			:imageUrl="`images/blog${index + 1}-img.webp`"
			:key="item.title"
			:title="item.title"
...
const blogItems = [
	{
		...
		description:
			"Venezuelan jewellery designer Mónica Sordo started her career in fashion in Europe, before returning home and embarking on a new journey that began...",
	},
	{
